...
public final class AstUtils {
    ...
    public static final String PARAMS_DEF_HEADER 	= "PARAMETERS DEF: ";
    ...
    public static final String POINTER_HEADER 		= "POINTER ";
    public static final String POINTER_NULL 		= "null";
