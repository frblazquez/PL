...
"3:8,4:2,1,3:2,4,3:18,4,3:7,10,11,9,8,3,7,3,2,6:10,3:3,12,3:3,5:26,3:6,5:26," +
"3:5,0:2")[0];

	private int yy_rmap[] = unpackFromString(1,14,
"0,1:2,2,1,3,4:3,1:4,5")[0];

	private int yy_nxt[][] = unpackFromString(6,13,
"1,2,3,4,2,5,6,7,8,9,10,11,12,-1:15,13,-1:15,5:2,-1:12,6,-1:8,13:11");
			...
			if (YY_F != yy_next_state) {
				...
				if (YY_NO_STATE == yy_last_accept_state) {
					...
					case -3:
						break;
					case 3:
						{return symbol("Dividido"       ,DIV, yytext()); }
					case -4:
						break;
					case 4:
					...
					case -5:
						break;
					case 5:
						{return symbol("Identificador"  ,IDEN, yytext()); }
					case -6:
						break;
					case 6:
		    {
			return symbol("Entero", ENT, yytext());
		    }
					case -7:
						break;
					case 7:
						{return symbol("Resta"          ,MENOS, yytext()); }
					case -8:
						break;
					case 8:
						{return symbol("Suma"           ,MAS, "+"); }
					case -9:
						break;
					case 9:
						{return symbol("Por"            ,POR, yytext()); }
					case -10:
						break;
					case 10:
						{return symbol("Parentesis ap"  ,PAP, yytext()); }
					case -11:
						break;
					case 11:
						{return symbol("Parentesis ci"  ,PCIERRE, yytext()); }
					case -12:
						break;
					case 12:
						{return symbol("Igual"          ,IGUAL, yytext()); }
					case -13:
						break;
					case 13:
						{}
